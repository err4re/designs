...
class Resistor:
    ...
    def create_right_arm_small(res_params: ResParams) -> Tuple[Device, Device]:
        ...
        #minimal spacing between left and right arm on the bottom
        min_spacing = 3
        ...
        Lr = Arm << pg.L(width=res_params.connector_height, 
                         size=(res_params.segment_length + res_params.connector_height/2 + res_params.arm_width,
                              res_params.total_spacing + max(min_spacing, res_params.spacing) + (res_params.num_segments)*res_params.resistor_width + res_params.connector_height/2),
