...
EBEAM_HIGH = 7
EBEAM_HIGH_DOSE = 2200

# strong current exposure for big structures
EBEAM_STRONG = 8
EBEAM_STRONG_DOSE = 1600

EBEAM_SMALL_JUNCTIONS = 9
EBEAM_SMALL_JUNCTIONS_DOSE = 3000

EBEAM_JUNCTIONS = 10
EBEAM_JUNCTIONS_DOSE = 2500

EBEAM_LARGE_JUNCTIONS = 11
EBEAM_LARGE_JUNCTIONS_DOSE = 1900

EBEAM_JUNCTIONS_STRESS = 12
EBEAM_JUNCTIONS_STRESS_DOSE = 2700
...
num_undercut_test_doses = 5
start_undercut_dose = 350
end_undercut_dose = 470
