...
class JJParams:
    ...
    stress_boxes_offset: float = 0.0
    stress_boxes_width: float = 0.08
...
class JJ:
    ...
    def create_jj_top(jj_params: JJParams) -> Device:
        ...
        JJ_Top << pg.rectangle(size=(jj_params.jj_width, jj_params.jj_length/2 - jj_params.bridge_width/2), layer=jj_params.junction_layer)
    ...
    def create_jj_bot(jj_params: JJParams) -> Device:
        ...
        JJ_Bot << pg.rectangle(size=(jj_params.jj_width, jj_params.jj_length/2 - jj_params.bridge_width/2), layer=jj_params.junction_layer)
    ...
    def create_undercut_h_boxes(jj_params: JJParams) -> Device:
        ...
        Box = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height), layer=jj_params.stress_layer)
        Upper_Undercut = Box << pg.rectangle(size=(jj_params.stress_boxes_undercut_width, jj_params.stress_boxes_undercut_height), layer=jj_params.undercut_layer).movex(jj_params.stress_boxes_width/2 - jj_params.stress_boxes_undercut_width/2).movey(jj_params.stress_boxes_height)
        Lower_Undercut = Box << pg.rectangle(size=(jj_params.stress_boxes_undercut_width, -jj_params.stress_boxes_undercut_height), layer=jj_params.undercut_layer).movex(jj_params.stress_boxes_width/2 - jj_params.stress_boxes_undercut_width/2)


        Left_Box = JJ_Undercut << Box
        Left_Box.move((-jj_params.undercut_extension - jj_params.stress_boxes_width/2 - jj_params.jj_width/2 - 2*jj_params.undercut_spacing_h - jj_params.stress_boxes_offset, -jj_params.stress_boxes_height/2))
        Right_Box = JJ_Undercut << Box
        Right_Box.move((jj_params.undercut_extension - jj_params.stress_boxes_width/2 + jj_params.jj_width/2 + 2*jj_params.undercut_spacing_h + jj_params.stress_boxes_offset, -jj_params.stress_boxes_height/2))

        H = pg.boolean(A=H, B=pg.offset([Left_Box, Right_Box], distance=2*jj_params.undercut_spacing_h), operation='A-B', layer=jj_params.undercut_layer)
    ...
    def create_undercut_h_sym_slits(jj_params: JJParams) -> Device:
        ...
        Slit = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height), layer=jj_params.stress_layer)
        Slit.rotate(45)
    ...
    def create_undercut_h_asym_slits(jj_params: JJParams) -> Device:
        ...
        Upper_Slit = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height), layer=jj_params.stress_layer)
        ...
        Lower_Slit = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height + np.sqrt(2)*4*jj_params.undercut_spacing_v), layer=jj_params.stress_layer)
    ...
    def generate_jj(self, jj_params: JJParams, overwrite: bool = False) -> None:
        if (self.device is not None) and not overwrite:
            ...
            Junction << [JJ_Top, JJ_Bot, Top_Arm, Bot_Arm]
