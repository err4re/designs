...
josephson_junction.generate_jj(jj_params=JJParams(total_length=15))
...
josephson_junction.device.remove_layers([default_ls['writefield_ebeam'], default_ls['working_area_ebeam']])

set_quickplot_options(show_ports=True, show_subports=False, new_window=True, blocking=True, label_aliases=True)

qp(josephson_junction.device)
