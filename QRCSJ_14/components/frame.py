...
class FrameParams:
    ...
    alignment_layer: Layer = default_ls['alignment']
...
class Frame:
    ...
    def create_corner_mark(frame_params: FrameParams) -> Device:
        ...
        Negative_Alignment_Mark << Cross.move((14*40 +15 +120 +15-5, 14*40 +15 +120 +15-5))
        ...
        #20micron square for EBPG5000 alignment
        EBPG_Mark = Device('EBPG alignment mark')
        Square = pg.rectangle(size=(20,20), layer=frame_params.optical_layer)
        Square.move(origin=Square.center, destination=(0,0))

        Mark = pg.rectangle(size=(20,20), layer=frame_params.alignment_layer)
        Mark.move(origin=Mark.center, destination=(0,0))
        EBPG_Mark << Mark

        Square_Frame = pg.rectangle(size=(200,200), layer=frame_params.optical_layer)
        Square_Frame.move(origin=Square_Frame.center, destination=(0,0))

        EBPG_Mark << pg.boolean(A=Square_Frame, B=Square, operation='A-B', layer=frame_params.optical_layer)

        Corner_Mark << EBPG_Mark.move((700,300))
    ...
    def create_corner_marks(frame_params: FrameParams) -> list[Device]:
        ...
        Mark_tr.mirror(p1=(-1, 0), p2=(1, 0)).mirror(p1=(0, -1), p2=(0, 1))
