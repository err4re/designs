...
class JJParams:
    ...
    stress_layer: Layer = default_ls['ebeam_junctions']
...
class JJ:
    ...
    def create_undercut_h_boxes(jj_params: JJParams) -> Device:
        ...
        Left_Box.move((-jj_params.undercut_extension - jj_params.stress_boxes_width/2 - jj_params.jj_width/2 - 2*jj_params.undercut_spacing_h, -jj_params.stress_boxes_height/2))
        Right_Box = JJ_Undercut << Box
        Right_Box.move((jj_params.undercut_extension - jj_params.stress_boxes_width/2 + jj_params.jj_width/2 + 2*jj_params.undercut_spacing_h, -jj_params.stress_boxes_height/2))
