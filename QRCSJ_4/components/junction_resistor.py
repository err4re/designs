...
class CapaParams:
    ...
    ebeam_capa_spacing: float = 2.2
    ebeam_capa_height: float = 4
    ebeam_capa_width: float = 20
...
class JJResistor():
    ...
    def create_connector(capa_params:CapaParams) -> Device:
        ...
        if capa_params.ebeam_capa:
            Horizontal, Undercut = Resistor.create_connector(ResParams(connector_width=capa_params.ebeam_capa_width, connector_height=capa_params.ebeam_capa_height))
