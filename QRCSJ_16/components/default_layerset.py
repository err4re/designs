...
start_undercut_dose = 450
end_undercut_dose = 750
...
num_undercut_test_doses = 5
start_undercut_dose = 540
end_undercut_dose = 660
...
default_ls.add_layer(name = 'routing',
                    gds_layer = ROUTING,
                    gds_datatype = 0,
                    description = 'layer for routing',
                    color = 'gold',
                    alpha=0.5)

default_ls.add_layer(name = 'alignment',
                    gds_layer = ALIGNMENT,
                    gds_datatype = 0,
                    description = 'layer for alignment marks',
                    color = 'red',
                    alpha=1)
...
for i, dose in enumerate(ebeam_test_doses):
    default_ls.add_layer(name = f'ebeam_test_{i}',
                    ...
                    description = 'layer for ebeam dose test',
                    color = 'blue')
