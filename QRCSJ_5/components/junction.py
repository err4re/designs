...
class JJParams:
    ...
    stress_boxes_height: float = 1.2
    stress_boxes_undercut_height: float = 0.5
    stress_boxes_undercut_width: float = 0.35
...
class JJ:
    ...
    def create_undercut_h_sym_slits(jj_params: JJParams) -> Device:
        ...
        Slit = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height), layer=jj_params.layer)
        Slit.rotate(45)
    ...
    def create_undercut_h_asym_slits(jj_params: JJParams) -> Device:
        ...
        Upper_Slit = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height), layer=jj_params.layer)
        ...
        Lower_Slit = pg.rectangle(size=(jj_params.stress_boxes_width, jj_params.stress_boxes_height + np.sqrt(2)*4*jj_params.undercut_spacing_v), layer=jj_params.layer)
